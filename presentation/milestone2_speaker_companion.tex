...
\begin{itemize}
  ...
  \item Walk-forward CV table: \highlight{train and val RMSE per model}. Convex SCM val/train ratio is 1.26 Hormuz / 1.16 Russia (clean). On Russia, ASCM 2.04 (just over 2$\times$ heuristic threshold) and XGBoost 3.00 + Bayesian Ridge 3.07 are the overfit-flagged cases.
