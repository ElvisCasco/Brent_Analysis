...
\begin{frame}{Comment 2 --- why the models behaved as they did}
  ...
  \begin{itemize}\setlength\itemsep{0.35em}
    ...
    \item[\textcolor{accent}{\hd{2}}] \hd{Signed contamination bias.} Are those donors themselves moved by the
      treatment (demand destruction)? Decompose each gap into a clean part and a donor-contamination part, and \emph{sign} it.
    \item[\textcolor{accent}{\hd{3}}] \hd{Leave-one-out robustness.} Does any single donor drive the gap?
  \end{itemize}
\end{frame}
...
% =====================================================================
\begin{frame}{Donor-free naive baselines}
  \footnotesize
  \hd{What does the donor-informed SCM buy us over baselines that ignore the donors?}

  \vspace{0.6em}
  \centering
  \includegraphics[width=0.96\textwidth,height=0.42\textheight,keepaspectratio]{../../plots/milestone3/naive_baselines.png}
