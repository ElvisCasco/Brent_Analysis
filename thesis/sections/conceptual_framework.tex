...
\emph{zero loading on} $o_t$, so a clean donor is exposed to the same global factors as
...
than coincidence. This is checked by using pre-period RMSPE, walk-forward cross-validation, and moment
matching.
...
\emph{down} (demand crowd-out, risk-off), then the ATT is \emph{over}-estimated. 
