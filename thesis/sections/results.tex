...
attainable floor, 0.050 in the 19-donor pool and 0.029 in the 32-donor pool. For
...
(\texttt{arima\_rw}), and an imposed-mean-reversion ARIMA (\texttt{arima\_mr}). The dotted
