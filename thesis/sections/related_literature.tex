...
and \citet{athey2021mc} recast the problem as matrix completion. 

A caution runs through
all of it. Convex SCM weights are non-unique when donors are correlated
...
The
intersection we occupy, which is SCM on a crude-benchmark price under an exogenous
geopolitical disruption with cross-asset donors, has no direct precedent, and
...
pre-period fit can mask rather than remove contamination, and this is the logic we use to
