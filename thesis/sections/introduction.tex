...
expectations, since its estimand is a reduced-form total effect. Those institutions reach
a price path by the opposite route, imposing an assumed barrel shortfall and propagating it
through a structural model. Ours reads the effect from the market and assumes no shortfall,
