...
subtitle: "A Synthetic-Control Estimate of the Brent Crude Premium<br> from the 2026 Strait of Hormuz Disruption"
author:
  - "Cherryl Chico, Elvis Casco, Nikoloz Darsalia"
institute:
  - "Master Project — Data Science for Decision Making<br> Barcelona School of Economics<br>2026-07-03"
# date: 2026-07-03
format:
  revealjs:
    ...
    title-slide-attributes:
      data-background-image: "images/Strait_of_Hormuz_satellite_labeled.png"
...
## A historical parallel to test the machinery 
...
## {.center background-image="images/title_bg.jpg" background-size="cover" background-position="center" background-opacity="0.30" background-color="#0d1117"}
...
- [The institutional route runs the other way.]{style="font-size:1.25em; font-style:italic;"} [(World Bank, IEA)]{style="color:#9aa0b5;"} assume a barrel shortfall and model its price impact forward.
:::
...
::: {.fragment}
  ...
  <ul style="margin-top: 0.1em; margin-bottom: 0;">
    ...
    <li>Validation is internal and regime-bound; our methodology is not directly applicable to other oil shocks.</li>
  </ul>
:::
...
<div style="width: 100px; height: 2px; background: #ffd166; margin: 6px auto;"></div>
