...
## add here 3 slides on validation
...
- Hormuz added a premium of ~[half]{style="color:#ffd166;"} Brent's no-event price. Positive under every estimator, conservative if anything, no single donor or model.

[Contributions]{style="color:#ffd166;"}

- A data-driven premium that [complements]{style="color:#ffd166;"} — not competes with — institutional scenario estimates.
...
- Reduced-form total effect — not split into supply / risk / expectations.
- Low-power inference — the placebo's [0.050]{style="color:#ffd166;"} is the floor, not a rejection.
- Validation internal & regime-bound — calibrated by analogy to Russia.
